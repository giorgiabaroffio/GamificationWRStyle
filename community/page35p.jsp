...
<a href="#main-content" class="sr-only">Skip to main content</a>
	...
	<webratio:CollectScripts var="inlineScripts" enabled="${wrBoxed}" eventHandlerWrapper="wr.keepScoped">
		...
		<div class="wr-ajaxDiv" id="page35pHiddenFields">
...
<div class="container container-fixed-top-padding">
 ...
 <a class="small" href="<webratio:Link link="page36p.link"/>">
   Notification Area
		...
		<li class="active">Manage Containers</li>
	</ol>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="wr-ajaxDiv" id="page35p_grid_0">
<div class="container_12">
			<div class="grid_4 prefix_8 alpha omega agrd_8">
				<div class="wr-ajaxDiv" id="page35p_cell_8">
	<div class="wr-ajaxDiv" id="enu18p_0">
<div class="left-bar">
	...
	<div class="row"><div class="col-md-offset-2 col-md-10">
		<div class="form-group form-btn">
			...
			<div class="grid_12 alpha omega agrd_24">
				<div class="wr-ajaxDiv" id="page35p_cell_12">
	<div class="wr-ajaxDiv" id="pwu16p_0">
<c:choose>
...
<div class="left-bar">
	...
	<script type="application/json" class="wr-linkInfos">
		<webratio:LinkInfos page="page35p"/>
	</script>
		<script type="application/json" class="wr-linkInfosSelective">
			<webratio:LinkInfos page="page35p" selectiveRefresh="true"/>
		</script>
	<script type="application/json" class="wr-linkData">
		<webratio:LinkData page="page35p"/>
	</script>
