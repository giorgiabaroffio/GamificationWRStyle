		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">		      
	            <ul class="nav navbar-nav" role="menu">
								<li class="active"><a href="<webratio:Link escapeXml="true" link="page8q.link"/>"><bean:message key="Getting Started"/></a></li>
	            </ul>
...
<c:choose>
<c:when test="${not(empty dau2q) and (dau2q.dataSize gt 0)}">
<div class="panel panel-default ">
	...
	<div class="panel-body">
		<div class="">
				<div class="value"><c:out value="${dau2q.data.message}" escapeXml="false"/></div>
		</div>
	</div>
</div>     
</c:when>
