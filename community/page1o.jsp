...
<webratio:Page page="page1o"/>
<html lang="${LanguageISOCtxParam}">
	<head>
		<meta http-equiv="content-type" content="text/html; charset=utf-8">
	    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
		<base href="<%=wrBaseURI%>"/> 
		<title><bean:message key="HQ.NotPublicProfile"/></title>
...
<div class="container container-fixed-top-padding">
	<div class="page-header clearfix">
			<h1><bean:message key="HQ.NotPublicProfile"/></h1>
	</div>
	<div class="row">
		<div class="col-md-12">
...
<c:if test="${not(empty dau1o) and (dau1o.dataSize gt 0)}">
	...
	<div class="panel-body">
		<div class="">
			<div class="row">
				...
				<div class="value col-md-10"><c:out value="${dau1o.data.message}" escapeXml="false"/></div>
			</div>
		</div>
	</div>
</div>     
