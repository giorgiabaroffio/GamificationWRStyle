...
<webratio:Page page="page5p"/>
<html lang="${LanguageISOCtxParam}">
	<head>
		<meta http-equiv="content-type" content="text/html; charset=utf-8">
	    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
		<base href="<%=wrBaseURI%>"/> 
		<title><bean:message key="Getting Started"/></title>
	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			...
			<c:if test="${webratio:isTargetAccessible('page5p.link', pageContext)}">
								<li class="active"><a href="<webratio:Link escapeXml="true" link="page5p.link"/>"><bean:message key="Getting Started"/></a></li>
			</c:if>
...
<div class="container container-fixed-top-padding">
	<div class="page-header clearfix">
			<h1><bean:message key="Getting Started"/></h1>
	</div>
	<div class="row">
		<div class="col-md-12">
...
<c:choose>
<c:when test="${not(empty dau30p) and (dau30p.dataSize gt 0)}">
<div class="panel panel-default ">
	...
	<div class="panel-body">
		<div class="">
				<div class="value"><c:out value="${dau30p.data.message}" escapeXml="false"/></div>
		</div>
	</div>
</div>     
</c:when>
